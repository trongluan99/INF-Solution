...
import com.inf.module.adapter.ListSimpleAdapter;
...
public class SimpleListActivity extends AppCompatActivity {
    ...
    InfAdAdapter adAdapter;
    int layoutCustomNative = com.ads.inf.R.layout.custom_native_admod_medium;
    String idNative = "";
    SwipeRefreshLayout swRefresh;
    ListSimpleAdapter originalAdapter;
    RecyclerView recyclerView;
    InfAdPlacer.Listener listener = new InfAdPlacer.Listener() {
        @Override
...
//                setupAdAdapter();
        ...
        if (InfAd.getInstance().getMediationProvider() == InfAdConfig.PROVIDER_ADMOB) {
            layoutCustomNative = com.ads.inf.R.layout.custom_native_admod_medium;
            idNative = getString(R.string.admod_native_id);
        } else {
            layoutCustomNative = com.ads.inf.R.layout.custom_native_max_small;
    ...
    private void setupAdAdapter() {
        adAdapter = InfAd.getInstance().getNativeRepeatAdapter(this, idNative, layoutCustomNative, com.ads.inf.R.layout.layout_native_medium,
