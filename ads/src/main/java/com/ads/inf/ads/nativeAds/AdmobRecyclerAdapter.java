...
public class AdmobRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final InfAdPlacerSettings settings;

    private RecyclerView.Adapter adapterOriginal;
    private Activity activity;
    private InfAdPlacer adPlacer;
    private AdapterDataObserver adapterDataObserver = new AdapterDataObserver();

    public AdmobRecyclerAdapter(InfAdPlacerSettings settings, RecyclerView.Adapter adapterOriginal, Activity activity) {
        this.adapterOriginal = adapterOriginal;
        this.registerAdapterDataObserver(adapterDataObserver);
        this.activity = activity;
        this.settings = settings;
        adPlacer = new InfAdPlacer(settings, adapterOriginal, activity);
    }
    ...
    private class InfViewHolder extends RecyclerView.ViewHolder {
