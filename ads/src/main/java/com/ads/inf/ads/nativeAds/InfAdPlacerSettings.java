...
public class InfAdPlacerSettings {
    ...
    private InfAdPlacer.Listener listener;
    public InfAdPlacerSettings(String adUnitId, int layoutCustomAd, int layoutPlaceHolderAd) {
        this.adUnitId = adUnitId;
        this.layoutCustomAd = layoutCustomAd;
        this.layoutAdPlaceHolder = layoutPlaceHolderAd;
    }
    public InfAdPlacerSettings(int layoutCustomAd, int layoutPlaceHolderAd) {
        this.adUnitId = adUnitId;
        this.layoutCustomAd = layoutCustomAd;
        this.layoutAdPlaceHolder = layoutPlaceHolderAd;
    }
    ...
    public InfAdPlacer.Listener getListener() {
        return listener;
    }

    public void setListener(InfAdPlacer.Listener listener) {
