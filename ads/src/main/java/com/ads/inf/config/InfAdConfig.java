...
public class InfAdConfig {
    ...
    public InfAdConfig(Application application) {
        this.application = application;
    }

    public InfAdConfig(Application application, int mediationProvider, String environment) {
