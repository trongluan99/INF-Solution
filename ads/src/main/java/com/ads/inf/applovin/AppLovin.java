...
public class AppLovin {
    ...
    public void loadSplashInterstitialAds(final Context context, String id, long timeOut, long timeDelay, AppLovinCallback adListener) {
        ...
        interstitialSplash.setListener(new MaxAdListener() {
            ...
            public void onAdClicked(MaxAd ad) {
                ...
                InfLogEventManager.logClickAdsEvent(context, ad.getAdUnitId());
            }
    ...
    public void onShowSplash(Activity activity, AppLovinCallback adListener) {
        ...
        interstitialSplash.setRevenueListener(ad -> InfLogEventManager.logPaidAdImpression(context,ad, AdType.INTERSTITIAL));
        interstitialSplash.setListener(new MaxAdListener() {
            @Override
            public void onAdLoaded(MaxAd ad) {
            ...
            @Override
            public void onAdClicked(MaxAd ad) {
                InfLogEventManager.logClickAdsEvent(context, interstitialSplash.getAdUnitId());
                if (adListener != null) {
                    adListener.onAdClicked();
                }
                if (disableAdResumeWhenClickAds)
    ...
    public void showInterstitialAdByTimes(final Context context, MaxInterstitialAd interstitialAd, final AdCallback callback, final boolean shouldReloadAds) {
        ...
        interstitialAd.setRevenueListener(ad -> InfLogEventManager.logPaidAdImpression(context,ad, AdType.INTERSTITIAL));
        interstitialAd.setListener(new MaxAdListener() {
            @Override
            public void onAdLoaded(MaxAd ad) {
    ...
    private void loadBanner(final Activity mActivity, String id, final FrameLayout adContainer, final ShimmerFrameLayout containerShimmer) {
        ...
        adView.setRevenueListener(ad -> InfLogEventManager.logPaidAdImpression( mActivity,ad, AdType.BANNER));
    ...
    public void loadNativeAd(Activity activity, ShimmerFrameLayout containerShimmer, FrameLayout nativeAdLayout, String id, int layoutCustomNative) {
        ...
        nativeAdLoader.setRevenueListener(ad -> InfLogEventManager.logPaidAdImpression( activity,ad, AdType.NATIVE));
    ...
    public MaxRecyclerAdapter getNativeRepeatAdapter(Activity activity, String id, int layoutCustomNative, RecyclerView.Adapter originalAdapter,
        ...
        MaxNativeAdViewBinder binder = new MaxNativeAdViewBinder.Builder(layoutCustomNative)
                .setTitleTextViewId(com.ads.inf.R.id.ad_headline)
                .setBodyTextViewId(com.ads.inf.R.id.ad_body)
                .setAdvertiserTextViewId(com.ads.inf.R.id.ad_advertiser)
                .setIconImageViewId(com.ads.inf.R.id.ad_app_icon)
                .setMediaContentViewGroupId(com.ads.inf.R.id.ad_media)
                .setOptionsContentViewGroupId(com.ads.inf.R.id.ad_options_view)
                .setCallToActionButtonId(com.ads.inf.R.id.ad_call_to_action)
                .build();
    ...
    public void showRewardAd(Activity activity, MaxRewardedAd maxRewardedAd, AppLovinCallback callback) {
        if (maxRewardedAd.isReady()) {
            maxRewardedAd.setRevenueListener(ad -> InfLogEventManager.logPaidAdImpression( activity,ad, AdType.REWARDED));
