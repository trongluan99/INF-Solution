...
public class InfLogEventManager {

    private static final String TAG = "InfLogEventManager";
    ...
    public static void logPaidAdImpression(Context context, AdValue adValue, String adUnitId, String mediationAdapterClassName, AdType adType) {
        logEventWithAds(context, (float) adValue.getValueMicros(), adValue.getPrecisionType(), adUnitId, mediationAdapterClassName, InfAdConfig.PROVIDER_ADMOB);
        InfAdjust.pushTrackEventAdmob(adValue);
        InfAppsflyer.getInstance().pushTrackEventAdmob(adValue, adUnitId, adType);
    ...
    public static void logPaidAdImpression(Context context, MaxAd adValue, AdType adType) {
        ...
        InfAdjust.pushTrackEventApplovin(adValue, context);
        InfAppsflyer.getInstance().pushTrackEventApplovin(adValue, adType);
    }
    ...
    private static void logPaidAdImpressionValue(Context context, double value, int precision, String adunitid, String network, int mediationProvider) {
        ...
        InfAdjust.logPaidAdImpressionValue(value, "USD");
    ...
    public static void pushTrackEventApplovin(MaxAd ad, Context context) {
        InfAdjust.pushTrackEventApplovin(ad, context);
    }
}
