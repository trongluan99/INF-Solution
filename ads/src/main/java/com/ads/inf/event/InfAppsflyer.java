...
public class InfAppsflyer {
    private static final String TAG = "InfAppsflyer";
    private Context context;
    private static InfAppsflyer infAppsflyer;
    public static boolean enableAppsflyer = false;

    public InfAppsflyer() {
    }

    public static InfAppsflyer getInstance(){
        if (infAppsflyer ==null)
            infAppsflyer = new InfAppsflyer();
        return infAppsflyer;
    }
